...
static const char *TAG = "app_autofeeder";
uint16_t autofeeder_endpoint_id = 0;
...
extern "C" void app_main() {
    ...
    // Initialize servo driver and get a handle
    app_driver_handle_t autofeeder_handle = app_driver_autofeeder_init();

    ESP_LOGI(TAG, "Starting Matter Autofeeder Device");
    ...
    ESP_LOGI(TAG, "Autofeeder endpoint_id %d", autofeeder_endpoint_id);
        ...
        app_driver_servo_set_defaults(autofeeder_endpoint_id);
